...
//Existen celdas vacias ? True or False. Si false, tie game.
...
Tablero.prototype.dibujar=function(){
    ...
    for (var i=0;i<n;i++)
    {
        ...
        {
            this.celdas[i].innerHTML='<span style="color:'+((this.panel[i]==JUGADOR.HUMANO)?'red':'blue')+';">'+((this.panel[i]==JUGADOR.HUMANO)?'X':'0')+'</span>';
        }
    }
};
